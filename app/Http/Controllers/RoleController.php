...
class RoleController extends Controller
{
    ...
    {
        $role = Role::all();
         //debera retornar a la vista donde vas a reflejar todos los roles 
    ...
    {
        return view('admin.role.crear_rol');
    }
    ...
    public function store(Request $request)
    {
        ...
        $role = Role::create(['name' => $request->input('create')]);
        return back();
    }
    ...
    {
        //actualizando y asignando permisos a roles
